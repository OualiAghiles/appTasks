...
return gulp.src([ 'src/assets/js/plugins/store.js','src/assets/js/plugins/panels.js', 'src/assets/js/plugins/todos.js',  'src/assets/js/plugins/app.js','src/assets/js/test.js'])
.pipe(plumber({
  errorHandler: function (error) {
    console.log(error.message);
    this.emit('end');
