...
return gulp.src([ 'src/assets/js/plugins/store.js','src/assets/js/plugins/board/card.js', 'src/assets/js/plugins/board/mainPanel.js','src/assets/js/plugins/board/mainBoard.js',  'src/assets/js/plugins/app.js','src/assets/js/test.js'])
.pipe(plumber({
  errorHandler: function (error) {
    console.log(error.message);
    this.emit('end');
